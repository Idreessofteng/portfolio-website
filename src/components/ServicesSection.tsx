      ...
      <div className="max-w-5xl mx-auto">
        {services.map((service, i) => (
          <FadeIn key={service.number} delay={i * 0.1} y={20}>
            ...
            >
              <span className="text-ink font-black shrink-0" style={{ fontSize: 'clamp(3rem, 10vw, 140px)' }}>
                {service.number}
              </span>
              <div>
                <h3 className="text-ink font-medium uppercase mb-2" style={{ fontSize: 'clamp(1rem, 2.2vw, 2.1rem)' }}>
                  {service.name}
                </h3>
                <p
